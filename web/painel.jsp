            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="idadeInput" value="25 anos">
                    </div>
                    <div class="form-group">
                        <label for="nascimentoInput"><strong>Data de Nascimento</strong></label>
                        <input type="text" class="form-control" id="nascimentoInput" value="01/01/1998">
                    </div>
                    <div class="form-group">
                        <label for="nomeGuerraInput"><strong>Nome de Guerra</strong></label>
                        <input type="text" class="form-control" id="nomeGuerraInput" value="Soldier123">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="loginInput"><strong>Patente</strong></label>
                        <input type="text" class="form-control" id="loginInput" value="login">
                    </div>
                    <div class="form-group">
                        <label for="senhaInput"><strong>Patente</strong></label>
                        <input type="text" class="form-control" id="senhaInput" value="senha">
                    </div>
